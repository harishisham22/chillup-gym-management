...
public class deleteTrainerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String validate = dd.deleteTrainer(id, request);
            
            if(validate.equalsIgnoreCase("SUCCESS")){
                request.setAttribute("errMessage", "Trainer delete successful.");
                request.getRequestDispatcher("list-trainer.jsp").forward(request, response);
            }
            else{
