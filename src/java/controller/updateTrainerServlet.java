...
public class updateTrainerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String validate = ud.updateTrainer(id, tb);
            
            if(validate.equalsIgnoreCase("SUCCESS")){
                request.setAttribute("errMessage", "Trainer update successful.");
                request.getRequestDispatcher("update-trainer.jsp?ID="+id).forward(request, response);
            }
            else{
