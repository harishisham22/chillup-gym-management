...
<head>
  ...
  <title>Update Members | ChillUp Fitness</title>
    ...
    <div class="col-lg-8">
      <div class="card">
        <div class="card-body">
          ...
          <!-- Vertical Form -->
          <form action="updateMemberServlet" method="post" class="row g-3 needs-validation" novalidate>
              <input type="hidden" name="id" value="<c:out value="${row.MEMBER_ID}"/>">
            <div class="col-12">
              <label for="fullname" class="form-label">Full Name</label>
              <div class="input-group has-validation">
                <input type="text" name="fullname" class="form-control" id="fullname" value="<c:out value="${row.MEMBER_FULLNAME}"/>" required>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                <input type="number" name="age" class="form-control" id="age" value="<c:out value="${row.MEMBER_AGE}"/>" required>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                <input type="text" name="icno" class="form-control" id="icno" value="<c:out value="${row.MEMBER_ICNO}"/>" required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="input-group has-validation">
                        <select name="gender" class="form-select" aria-label="Default select example" required>
                            <option value="<c:out value="${row.MEMBER_GENDER}"/>" selected hidden><c:out value="${row.MEMBER_GENDER}"/></option>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" name="email" class="form-control" id="email" value="<c:out value="${row.MEMBER_EMAIL}"/>" required>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                <input type="text" name="phone" class="form-control" id="phone" value="<c:out value="${row.MEMBER_PHONE}"/>" required>
