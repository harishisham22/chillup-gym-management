...
<head>
  ...
  <title>Programs List | ChillUp Fitness</title>
            ...
            <table class="table datatable">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="col-7">Program </th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rows}">
                        <tr>
                            <th scope="row"><c:out value="${row.PROGRAM_ID}"/></th>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<c:out value="${row.PROGRAM_ID}"/>">
                                    <i class="bi bi-trash"> Remove</i>
                                </button>
                                <!--   Begin Delete Modal    -->
                                <div class="modal fade" id="deleteModal<c:out value="${row.PROGRAM_ID}"/>" tabindex="-1">
