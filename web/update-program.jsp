...
<head>
  ...
  <title>Update Programs | ChillUp Fitness</title>
...
<%@include  file="sidebar.jsp" %>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Programs</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Update Program Details</h5>
  
            <!-- Vertical Form -->
            <form action="updateProgramServlet" method="post" class="row g-3 needs-validation" novalidate>
                <input type="hidden" name="program_id" value="<c:out value="${row.PROGRAM_ID}"/>">
              <div class="col-12">
                <label for="fullname" class="form-label">Program Name</label>
                <div class="input-group has-validation">
                    <input type="text" name="program_name" class="form-control" id="program_name" value="<c:out value="${row.PROGRAM_NAME}"/>" required>
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <select name="program_intensity" class="form-select" aria-label="Default select example" required>
                              <option value="<c:out value="${row.PROGRAM_INTENSITY}"/>" selected hidden><c:out value="${row.PROGRAM_INTENSITY}"/></option>
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <select name="program_duration" class="form-select" aria-label="Default select example" required>
                              <option value="<c:out value="${row.PROGRAM_DURATION}"/>" selected hidden><c:out value="${row.PROGRAM_DURATION}"/></option>
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                    <textarea name="program_desc" class="form-control" id="program_desc"><c:out value="${row.PROGRAM_DESC}"/></textarea>
                </div>
              </div>
