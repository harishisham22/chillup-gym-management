...
<head>
  ...
  <title>Add Class | ChillUp Fitness</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="col-lg-8">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Insert New Class Details</h5>

          <!-- Vertical Form -->
            <form action="addClassServlet" method="post" class="row g-3 needs-validation" novalidate>
                <div class="col-6">
                  ...
                  <div class="col-sm-10">
                    <select name="program" class="form-select" aria-label="Default select example">
                      ...
                      <c:forEach var="row" items="${program.rows}" >
                          <option value="<c:out value="${row.PROGRAM_NAME}"/>"><c:out value="${row.PROGRAM_NAME}"/></option>
                      </c:forEach>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <select name="trainer" class="form-select" aria-label="Default select example">
                      ...
                      <c:forEach var="row" items="${trainer.rows}" >
                          <option value="<c:out value="${row.TRAINER_FULLNAME}"/>"><c:out value="${row.TRAINER_FULLNAME}"/></option>
                      </c:forEach>
                    </select>
                  </div>
                </div>
