...
<head>
  ...
  <title>Signup | ChillUp Fitness</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-5">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Register Admin Account</h5>
                    <p class="text-center small">Enter your account details</details></p>
                  </div>

                  <form action="signupServlet" method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <c:set var="errMessage" scope="request" value="<%= (String) request.getAttribute("errMessage")%>"/>
                      ...
                      <div class="col-12">
                          <p class="small mb-0">Already have an account? <a href="login.jsp">Back to Login</a></p>
                      </div>
                  </form>
                </div>
              </div>
