<%-- 
    Document   : index
    Created on : Feb 2, 2023, 1:50:35 PM
        ...
        <nav class="header-nav ms-auto">
          <ul class="d-flex align-items-center">
            <li class="nav-item dropdown pe-3">
              ...
              <a class="nav-link nav-profile d-flex align-items-center pe-0" href="login.jsp">
            ...
            <li class="nav-item dropdown pe-3">
              ...
              <a class="nav-link nav-profile d-flex align-items-center pe-0" href="signup.jsp">
                <span class="d-none d-md-block ps-2">SIGN UP</span>
              </a>
